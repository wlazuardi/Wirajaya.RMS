...
_rdc.ASContextMenu.IsContextMenuShowed["contextmenumark"+menuElementId]=true;if(e.preventDefault){e.preventDefault();e.stopPropagation();}else{e.keyCode=0;e.returnValue=false;e.cancelBubble=true;}}
else
